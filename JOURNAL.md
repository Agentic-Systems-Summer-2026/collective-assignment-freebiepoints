...
## Day 10(ish) - BC4 Evaluation
- **What I built:** The BC4-evals evaluation harnes for my capstone project and a 15-case test suite. I also set up a GitHub actions CI pipeline to act as an automated regression gate
